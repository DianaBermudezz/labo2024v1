...
PARAM$semillas <- c(100003,100019,100043,100049,100057)
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) 
    for(vcp in c(-1,0,1))
      for(vminbucket in unique(c(vmin_split/2,vmin_split/3,vmin_split/4,vmin_split/5,10,5,2,1))){ 
    ...
    tb_grid_search <- rbindlist( 
      list( tb_grid_search, 
            list( vcp,vmax_depth,vminbucket, vmin_split, ganancia_promedio) ) )
